...
const FAQ_ITEMS = [
  ...
  {
    q: "¿Puedo invitar a GOTT a dar una plática en mi parroquia o comunidad?",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <button onClick={() => nav("home")} className="flex items-center gap-2.5">
            <div>
              <div className="font-bold text-[#8B4513] text-base leading-none" style={serif}>GOTT</div>
              <div className="text-[10px] text-gray-400 font-medium tracking-wide hidden sm:block">
                Grupo de Oración Teresiano
              </div>
            </div>
          </button>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
          <div className="max-w-2xl">
            ...
            <h1
              ...
              style={serif}
            >¿Qué es GOTT?<br /></h1>
            <p className="text-base md:text-lg text-white/80 mb-7 md:mb-10 leading-relaxed max-w-xl">El Grupo de Oración Teresiano de Tampico (GOTT) es una comunidad espiritual que promueve el encuentro íntimo con Dios a través de la oración, el estudio y la vivencia diaria de la espiritualidad de Santa Teresa de Jesús.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-6">
                En GOTT buscamos crecer juntos en la fe inspirados por Santa Teresa de Jesús. A través de la oración constante y el estudio, creamos un ambiente donde todos pueden experimentar el amor de Cristo.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-4">
                El Grupo de Oración Teresiano de Tampico (GOTT) nació con una convicción profunda: acercar las almas a Dios a través de la oración íntima. Somos una comunidad centrada en Cristo donde se comparte el Evangelio, se enseña la riqueza de la espiritualidad carmelitana y se acoge a cada persona con amor.
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <SectionHeading>Coordinación GOTT</SectionHeading>
          </div>
          <div className="flex justify-center">
  ...
  return (
    <div>
      <section className="relative h-64 flex items-center bg-[#8B4513] overflow-hidden">
        ...
        />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionLabel>MOMENTOS GOTT</SectionLabel>
              ...
              <div className="bg-[#F5EFE8] rounded-2xl p-5 md:p-8">
                {tab === "membership" && (
                  <div>
                    ...
                    <div className="mb-6">
                      <label className="block text-xs font-semibold text-gray-500 mb-1.5">¿Cómo te enteraste de GOTT? (o déjanos un mensaje)</label>
                ...
                {tab === "sponsor" && (
                  <div>
                    ...
                    <div className="mb-6">
                      <label className="block text-xs font-semibold text-gray-500 mb-1.5">¿Cómo te gustaría apoyar a GOTT?</label>
                      <textarea className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#8B4513]/20 h-24 resize-none" placeholder="Describe cómo te gustaría colaborar con GOTT..." />
                    </div>
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex bg-[#8B4513] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <button onClick={() => nav("home")} className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-xl bg-white/20 flex items-center justify-center">
              <span className="text-white font-bold text-xs" style={serif}>GOTT</span>
            </div>
        ...
        <div className="relative z-10 text-white/40 text-xs">
          © 2026 GOTT. Todos los derechos reservados.
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-5 md:p-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-400 text-sm mb-7">Inicia sesión en tu cuenta de GOTT</p>
    ...
    <footer className="bg-[#5C2D0E] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-white font-bold text-xl" style={serif}>
                MOVA<span className="text-[#D4AF37]">.</span>
              </span>
            </div>
            <p className="text-white/40 text-xs mb-3">Diseño y desarrollo web</p>
            <p className="text-white/50 text-xs leading-relaxed mb-4">
              Impulsando proyectos con propósito y comunidad en Tampico.
            </p>
            <div className="flex gap-2">
              {["FB", "IG", "YT", "TW"].map((s) => (
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/30 text-xs">© 2026 GOTT. Desarrollado por MOVA. Todos los derechos reservados.</p>
